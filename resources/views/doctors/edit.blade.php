    ...
    <div class="card shadow">
        <div class="card-header border-0">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="mb-0">Editar paciente | {{ $doctor->name }}</h3>
                </div>
        ...
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('doctors.update', ['user' => $doctor->id]) }}" enctype="multipart/form-data" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <textarea name="address" id="address" class="form-control" cols="30" rows="10"> {{ $doctor->address }}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="photo" id="photo" class="form-control" value="{{ $doctor->photo }}">
                    <span class="avatar avatar-lg  mt-4">
                    <img src="{{ asset('storage/photosProfile/'.$doctor->photo) }}" alt="{{ $doctor->photo }}">
                    </span>
                </div>
